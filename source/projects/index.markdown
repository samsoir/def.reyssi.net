...
<p>{{'![OU Annotate](/assets/images/OU-Annotate.png)'|markdownify}}</p>
...
<p>{{'![MyCW](/assets/images/mycw.png)'|markdownify}}</p>
...
<p>{{'![Contact Packaging](/assets/images/Contact-Packaging.png)'|markdownify}}</p>
